...
export const ExclamationIcon = ({ className = "w-4 h-4" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const CarIcon = ({ className = "w-4 h-4" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l1.5-4.5A2 2 0 018.39 4h7.22a2 2 0 011.89 1.5L19 10m-14 0v7a2 2 0 002 2h1m14-9v7a2 2 0 01-2 2h-1m-12-2h.01M19 17h.01M8 14a1 1 0 100-2 1 1 0 000 2zm8 0a1 1 0 100-2 1 1 0 000 2z" />
  </svg>
);
